...
export default function PageChatBot({ isOpen, onClose, pageContext, pageSpecificQuestions = [] }: PageChatBotProps) {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">
                Ask about Selma's {pageContext.toLowerCase()} and more
              </p>
            </div>
          </div>
          <button
