...
export default function ChatBot({ isOpen, onClose }: ChatBotProps) {
  ...
  const suggestedQuestions = [
    "What's Selma's background in AI and data engineering?",
    "What programming languages does she know?",
    "Can you tell me about her recent projects?",
    "What makes her a strong candidate?",
            ...
            <div className="flex flex-wrap gap-2">
              {suggestedQuestions.map((question, index) => (
                <button
                  ...
                  className="text-xs bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition"
                >
                  {question}
                </button>
              ))}
        ...
        <form onSubmit={handleSubmit} className="p-4 border-t border-gray-200 dark:border-gray-700">
          <div className="flex space-x-2">
            <input
              ...
              className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-gray-100"
              disabled={isLoading}
            />
            <button
              type="submit"
